...
type ButtonVariant = Exclude<ButtonVariantProps["variant"], null | undefined>
type ButtonColor = ButtonVariant | "primary"
...
function buttonVariants({
  ...
  const resolvedVariant =
    variant ?? (color === "primary" ? "default" : color ?? undefined)

  return buttonVariantStyles({
